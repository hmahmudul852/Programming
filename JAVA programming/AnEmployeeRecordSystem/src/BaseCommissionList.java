...
public class BaseCommissionList
{
	private List<BaseCommission> list=new ArrayList<BaseCommission>();
	
	public void addEmployee(String n,double p,double s,double r)
	{
		list.add(new BaseCommission(n,p,s,r));
	}
